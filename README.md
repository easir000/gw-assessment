...
│  • Keyword-based classification ($0 cost)                        │
│  • 5 intents: SALES_RECO, COMPLIANCE_CHECK,                      │
│    VENDOR_ONBOARDING, OPS_STOCK, GENERAL_KB                      │
│  • Parameter extraction: product_id, budget, state               │
└────────────────────────┬────────────────────────────────────────┘
                         │
                         ▼
┌─────────────────────────────────────────────────────────────────┐
...
│  • Chain selection based on intent                               │
...
│ core/tools/     │             │ utils/llm_stub  │
│ • hot_picks     │             │ • format_response│
│ • compliance    │             │ • estimate_tokens│
│ • stock         │             │ • sanitize_for_ │
│ • vendor        │             │   llm()         │
│ • kb_search     │             │                 │
└────────┬────────┘             └────────┬────────┘
